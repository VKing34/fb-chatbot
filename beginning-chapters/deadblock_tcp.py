...
def client(host, port, bytecount):
    ...
    print('Recieving all the data the server sends back')
    received = 0
    while True:
        data = sock.recv(42)
        if not received:
...
if __name__ == '__main__':
    ...
    parser.add_argument('bytecount',type=int, nargs='?', default=16, help='number of bytes for bytes to send (default 16)')
